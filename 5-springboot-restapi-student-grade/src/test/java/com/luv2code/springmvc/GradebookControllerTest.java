...
public class GradebookControllerTest {
    ...
    {
        Optional<CollegeStudent> student = studentDao.findById(0); //doesn't exist.
    ...
    public void createAValidGradeHttpRequestStudentDoesNotExistEmptyResponse() throws Exception
    {
        this.mockMvc.perform(post("/grades")
                ...
                .param("grade","85.00")
                .param("gradeType","math")
                .param("studentId", "0")) //doesn't exist
                .andExpect(jsonPath("$.status",is(404)))
                .andExpect(jsonPath("$.message",is("Student or Grade was not found")));
    }
    ...
    public void createNonValidGradeHttpRequestGradeTypeDoesNotExistEmptyResponse() throws Exception
    {
        this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade","85.00")
                        .param("gradeType","literature") //only have math, science and history
                        .param("studentId", "1"))
                .andExpect(jsonPath("$.status",is(404)))
                .andExpect(jsonPath("$.message",is("Student or Grade was not found")));
    }
